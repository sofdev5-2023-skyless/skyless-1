...
<tr class="hover" class:line-through={isDone}>
	...
	<div class="fixed inset-0 flex items-center justify-center z-50">
		<div class="modal modal-open">
			<div class="modal-box">
				<h2 class="text-xl">Confirmar eliminación</h2>
				<p>¿Estás seguro de que quieres eliminar esta cita?</p>
				<div class="modal-action">
					<button class="btn" on:click={() => { isConfirmationModalVisible = false; }}>
						Cancelar
					</button>
					<button class="btn btn-error" on:click={() => { deleteAppointment(id_appointment); isConfirmationModalVisible = false; }}>
						Confirmar
					</button>
				</div>
			</div>
